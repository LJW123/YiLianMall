...
public class MoneyUtil {
     ...
     */
    public static String getTwoDecimalPlaces(String serverLeBi) {
...
//            Logger.i("split To String:" + split[0] + "   " + split[1]);
    ...
    public static Spanned setSmall¥Money(String money) {
        if (money.contains(".")) {
            String[] split = money.split("\\.");
            return Html.fromHtml("<font  ><small><small>¥</small></small></font>" + split[0] + "." + "<font  ><small><small>" + split[1] + "</small></small></font>");
        }
...
//            Logger.i("split To String:" + split[0] + "   " + split[1]);
    ...
    public static String add¥Front(String money) {
        return "¥" + money;
    }
