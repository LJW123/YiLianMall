...
public class StatusBarUtils {
     ...
     * @param activity
     * @param colorResId
     * @param isKeepStatusBar 状态栏不遮盖页面内容
     */
    public static void setStatusBarColor(Activity activity, int colorResId, boolean isKeepStatusBar) {
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {
            Window window = activity.getWindow();
            window.addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
            if (isKeepStatusBar) {
                keepStatusBar(window);
            }
    ...
    /**
     * 保持Activity内容不被statusBar遮盖
     *
     * @param window
     */
    public static void keepStatusBar(Window window) {
