...
public class UmengDialog extends Dialog implements OnItemClickListener, View.OnClickListener {
    ...
    public UmengDialog(Context context, ArrayList<IconModel> array) {
        super(context);
        mContext = context;
        view = LayoutInflater.from(mContext).inflate(R.layout.library_module_umeng_share_dialog,
                null);
        icon = array;
    }
        ...
        public View getView(int arg0, View arg1, ViewGroup arg2) {
            ...
            if (arg1 == null) {
                arg1 = LayoutInflater.from(mContext).inflate(
                        R.layout.library_module_item_umeng_grid, null);
                hoder = new Hodler();
            ...
            switch (model.getType()) {
                case 0:
                    hoder.img.setImageResource(R.mipmap.library_module_wx);
                    break;
                case 1:
                    hoder.img.setImageResource(R.mipmap.library_module_weixinpengyouquan);
                    break;
            /*case 2:
				hoder.img.setImageResource(R.drawable.xinlangweibo);
				break;*/
                case 3:
                    hoder.img.setImageResource(R.mipmap.library_module_qkongjian);
                    break;
                case 4:
                    hoder.img.setImageResource(R.mipmap.library_module_qqhaoyou);
                    break;
			/*case 5:
