...
public class SlantedTextView extends View {
    ...
    public void init(AttributeSet attrs) {
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.library_module_SlantedTextView);

        mTextSize = array.getDimension(R.styleable.library_module_SlantedTextView_library_module_slantedTextSize, mTextSize);
        mTextColor = array.getColor(R.styleable.library_module_SlantedTextView_library_module_slantedTextColor, mTextColor);
        mSlantedLength = array.getDimension(R.styleable.library_module_SlantedTextView_library_module_slantedLength, mSlantedLength);
        mSlantedBackgroundColor = array.getColor(R.styleable.library_module_SlantedTextView_library_module_slantedBackgroundColor, mSlantedBackgroundColor);

        if (array.hasValue(R.styleable.library_module_SlantedTextView_library_module_slantedText)) {
            mSlantedText = array.getString(R.styleable.library_module_SlantedTextView_library_module_slantedText);
        }

        if (array.hasValue(R.styleable.library_module_SlantedTextView_library_module_slantedMode)) {
            mMode = array.getInt(R.styleable.library_module_SlantedTextView_library_module_slantedMode, 0);
        }
        array.recycle();
