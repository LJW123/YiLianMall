...
//	public static final int AnticipateOvershoot = 7;
    ...
    public static void tableBarAnimation(Context context, View view) {
        Animation scale = AnimationUtils.loadAnimation(context, R.anim.library_module_anim_scale_tablebar);
