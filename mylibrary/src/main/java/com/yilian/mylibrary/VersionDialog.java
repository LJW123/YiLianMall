...
public class VersionDialog extends Dialog {
	...
	public static class Builder {  
		...
		public VersionDialog create() {
			...
			final VersionDialog dialog = new VersionDialog(context,R.style.library_module_Dialog);
			View layout = inflater.inflate(R.layout.library_module_dialog_new_version, null);
