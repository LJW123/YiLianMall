...
public class RegExUtils {
     ...
     * 汉字、字母、数字正则
     */
    public static final String NUMBER_ENGLISH_CHINESE = "^[0-9a-zA-Z\\u4e00-\\u9fa5]{0,}$";
    /**
     * Email正则表达式="^([a-z0-9A-Z]+[-|\\.]?)+[a-z0-9A-Z]@([a-z0-9A-Z]+(-[a-z0-9A-Z]+)?\\.)+[a-zA-Z]{2,}$";
     */
    /**
     * 8-18位数组字母组合  用于快递单号正则
     */
    public static final String EXPRESSNUMBER = "^[a-zA-Z0-9]{8,18}$";
...
//    public static final String PHONE = "(^(\\d{2,4}[-_－—]?)?\\d{3,8}([-_－—]?\\d{3,8})?([-_－—]?\\d{1,7})?$)|(^0?1[35]\\d{9}$)";
    public static final String PHONE = PHONE_REGEX;
    /**
     ...
     * 银行卡号
     */
    public static final String BANK_CARD_NUMBER = "^([1-9]{1})(\\d{15}|\\d{18})$";
////------------------验证方法       
    ...
    public static boolean isExpressNum(String str) {
        return Regular(str, EXPRESSNUMBER);
    }
    ...
    public static boolean isNumberEnglishChinexe(String str) {
        return Regular(str, NUMBER_ENGLISH_CHINESE);
    }
