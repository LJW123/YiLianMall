...
public class NoticeListAdapter extends RecyclerView.Adapter<NoticeListAdapter.NoticeViewHolder> {
    ...
    public NoticeListAdapter(Context mContext, ArrayList<NoticeModel.NewsBean> list) {
    ...
    public NoticeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.item_notice_list, parent, false);
