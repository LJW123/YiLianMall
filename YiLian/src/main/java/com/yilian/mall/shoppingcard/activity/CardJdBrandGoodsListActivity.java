 ...
 * 购物卡  京东品牌商品列表页面
 *
 * @author Created by Zg on 2018/11/17.
 */

public class CardJdBrandGoodsListActivity extends BaseFragmentActivity implements View.OnClickListener {
    ...
    private void getGoodsListData() {
        Subscription subscription = RetrofitUtils3.getRetrofitService(context)
                .getCardJdBrandGoodsList("shoppingCardBrandGoodsList", page, Constants.PAGE_COUNT, brandName, SORT, orderBy,STATE)
