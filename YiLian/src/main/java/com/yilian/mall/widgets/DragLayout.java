...
public class DragLayout extends ViewGroup {
	...
	private ShowTopPageNotifier toppageListener;
	...
	private void animTopOrBottom(View releasedChild, float yvel) {
		...
		if (releasedChild == frameView1) {
			...
			if (yvel > VEL_THRESHOLD
				...
				if(null != toppageListener){
					toppageListener.onDragTop();
				}
			}
		}
	...
	public void setTopPageListener(ShowTopPageNotifier topPageListener){
		this.toppageListener = topPageListener;
	}

	public interface ShowTopPageNotifier {
