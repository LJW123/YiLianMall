...
public class RayScrollView2 extends ScrollView {
    ...
    public RayScrollView2(Context context) {
        super(context);
    }

    public RayScrollView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RayScrollView2(Context context, AttributeSet attrs, int defStyleAttr) {
