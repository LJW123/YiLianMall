...
public class MerchantUpdateDialog extends Dialog {

	public MerchantUpdateDialog(Context context) {
		super(context);
	}

	public MerchantUpdateDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public Builder setMessage(CharSequence message,int icon,int gravity) {
			this.icon = icon;
		...
		public MerchantUpdateDialog create() {
			LayoutInflater inflater = (LayoutInflater) context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			// instantiate the dialog with the custom Theme
			final MerchantUpdateDialog dialog = new MerchantUpdateDialog(context, R.style.library_module_Dialog);
