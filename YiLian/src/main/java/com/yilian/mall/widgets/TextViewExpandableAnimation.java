...
public class TextViewExpandableAnimation extends LinearLayout
    ...
    private void initValue(Context context, AttributeSet attrs) {
        ...
        if (null == drawableShrink) {
            drawableShrink = ContextCompat.getDrawable(context, R.mipmap.library_module_icon_arrow_up);
        }

        if (null == drawableExpand) {
            drawableExpand = ContextCompat.getDrawable(context, R.mipmap.library_module_icon_arrow_up);
        }
