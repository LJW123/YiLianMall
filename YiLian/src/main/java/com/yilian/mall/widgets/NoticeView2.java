...
import com.yilian.mall.ui.NoticeListActivity;
...
//                    if (isLogin()) {
//                    } else {
//                        mContext.startActivity(new Intent(mContext, LeFenPhoneLoginActivity.class));
//                    }
                }
            });
    ...
    private void showDialog(ArrayList<NoticeViewEntity> jpNews) {
        for (int i = 0; i < jpNews.size(); i++) {
            NoticeViewEntity activityNews = jpNews.get(i);
            View view = View.inflate(mContext, R.layout.layout_jp_main_notice, null);
            ...
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    builder.setTitle("公告");
                    builder.setMessage(activityNews.msg);
                    builder.show();
                }
            });
            ...
            TextView tvNotice = (TextView) view.findViewById(R.id.tv_notice);
            tvNotice.setText(activityNews.msg);
            View viewVer = view.findViewById(R.id.view_ver);
            viewVer.setVisibility(GONE);
            TextView tvMoreNotice = (TextView) view.findViewById(R.id.tv_more_notice);
            tvMoreNotice.setVisibility(GONE);
            LayoutParams lp = new LayoutParams(
                    LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
            viewFlipper.addView(view, lp);
        }
