...
/*
 * Copyright (C) 2013 The Android OpenInitialPayActivityBroadcastReceiver Source Project
 *
...
class SwipeRefresh extends ViewGroup {
    ...
    protected CircleImageView2 mCircleView;
    ...
    private void createProgressView() {
        mCircleView = new CircleImageView2(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
