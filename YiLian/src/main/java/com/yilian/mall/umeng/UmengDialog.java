...
public class UmengDialog extends Dialog implements OnItemClickListener, android.view.View.OnClickListener {
    ...
    public UmengDialog(Context context, ArrayList<IconModel> array) {
        super(context);
        mContext = context;
        view = LayoutInflater.from(mContext).inflate(R.layout.umeng_share_dialog,
                null);
        icon = array;
    }
    ...
    public class IconAdapter extends BaseAdapter {
        ...
        public View getView(int arg0, View arg1, ViewGroup arg2) {
            ...
            switch (model.getType()) {
                case 0:
                    hoder.img.setImageResource(R.mipmap.wx);
                    break;
                case 1:
                    hoder.img.setImageResource(R.mipmap.weixinpengyouquan);
                    break;
            /*case 2:
				hoder.img.setImageResource(R.drawable.xinlangweibo);
				break;*/
                case 3:
                    hoder.img.setImageResource(R.mipmap.qkongjian);
                    break;
                case 4:
                    hoder.img.setImageResource(R.mipmap.qqhaoyou);
                    break;
			/*case 5:
