package com.yilian.mall.ctrip.widget.cosmocalendar.adapter;
...
import com.yilian.mall.ctrip.widget.cosmocalendar.utils.DayFlag;
import com.yilian.mall.ctrip.widget.cosmocalendar.view.CalendarView;
import com.yilian.mall.ctrip.widget.cosmocalendar.view.ItemViewType;
import com.yilian.mall.ctrip.widget.cosmocalendar.view.delegate.DayDelegate;
import com.yilian.mall.ctrip.widget.cosmocalendar.view.delegate.DayOfWeekDelegate;
import com.yilian.mall.ctrip.widget.cosmocalendar.view.delegate.MonthDelegate;
import com.yilian.mall.ctrip.widget.cosmocalendar.view.delegate.OtherDayDelegate;
...
public class MonthAdapter extends RecyclerView.Adapter<MonthHolder> {
    ...
    public void onBindViewHolder(MonthHolder holder, int position) {
        Log.i("已加载月数量：",String.valueOf(months.size()));
