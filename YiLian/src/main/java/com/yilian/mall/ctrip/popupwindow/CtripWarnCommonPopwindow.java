 ...
 */
public class CtripWarnCommonPopwindow extends PopupWindow {
    ...
    public CtripWarnCommonPopwindow(final Context mContext) {
        this.view = LayoutInflater.from(mContext).inflate(R.layout.ctrip_popupwindow_warn_comm, null);
