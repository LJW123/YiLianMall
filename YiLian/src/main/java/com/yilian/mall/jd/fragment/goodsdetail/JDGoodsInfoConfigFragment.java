 ...
 * 图文详情里的规格参数的Fragment
 */
public class JDGoodsInfoConfigFragment extends Fragment {
    ...
    static JDGoodsInfoConfigFragment newInstance(String htmlText) {
        JDGoodsInfoConfigFragment goodsInfoConfigFragment = new JDGoodsInfoConfigFragment();
