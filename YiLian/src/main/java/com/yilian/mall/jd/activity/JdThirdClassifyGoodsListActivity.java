...
public class JdThirdClassifyGoodsListActivity extends BaseActivity {
    /**
     * 价格升序
     */
    ...
    private void getGoodsList() {
        Subscription subscription = RetrofitUtils3.getRetrofitService(mContext)
                .getJdThirdClassifyGoodsList("jd_goods/jd_goods_list", page, Constants.PAGE_COUNT, catId, sort, orderBy)
