package com.yilian.mall.jd.view;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.shop_detail_red;
...
//        dividerPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsDividerPadding, dividerPadding);
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mOnPagerTitleItemClickListener != null) {
                    mOnPagerTitleItemClickListener.onClickItem(position);
                }
            }
        });
    ...
    public void setOnPagerTitleItemClickListener(OnPagerTitleItemClickListener onPagerTitleItemClickListener) {
        ...
        mOnPagerTitleItemClickListener = onPagerTitleItemClickListener;
    }
