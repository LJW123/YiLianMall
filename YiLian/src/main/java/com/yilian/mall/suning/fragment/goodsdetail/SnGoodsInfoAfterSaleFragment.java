 ...
 * 图文详情里的包装售后的Fragment
 */
public class SnGoodsInfoAfterSaleFragment extends Fragment {
    ...
    static SnGoodsInfoAfterSaleFragment newInstance(String packList, String afterSaleService) {
        SnGoodsInfoAfterSaleFragment goodsInfoServiceFragment = new SnGoodsInfoAfterSaleFragment();
