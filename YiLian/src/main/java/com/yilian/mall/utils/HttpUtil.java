...
public class HttpUtil {
    ...
    OkHttpClient client;
    String httpSchema = Constants.CLOUDAPI_HTTP;
    ...
    private HttpUtil(){
        ...
        if(Constants.IS_HTTPS){
            httpSchema = Constants.CLOUDAPI_HTTPS;
    ...
    public void httpGet(String path , Map<String , String> pathParams , Map<String , String> queryParams , Map<String , String> headerParams , Callback callback)
    {
        ...
        Request request = this.buildHttpRequest(httpSchema , Constants.CLOUDAPI_GET , Constants.APP_HOST , path , pathParams , queryParams , null  , null , Constants.CLOUDAPI_CONTENT_TYPE_FORM , Constants.CLOUDAPI_CONTENT_TYPE_JSON , headerParams);
    ...
    public void httpPostForm(String path , Map<String , String> pathParams , Map<String , String> queryParams , Map<String , String> formParams , Map<String , String> headerParams , Callback callback)
    {
        ...
        Request request = this.buildHttpRequest(httpSchema , Constants.CLOUDAPI_POST , Constants.APP_HOST , path , pathParams , queryParams , formParams , null , Constants.CLOUDAPI_CONTENT_TYPE_FORM , Constants.CLOUDAPI_CONTENT_TYPE_JSON , headerParams);
        Call call = client.newCall(request);
        try {
            Response respnose = call.execute();
            callback.onResponse(call , respnose);
    ...
    public void httpPostBytes(String path , Map<String , String> pathParams , Map<String , String> queryParams , byte[] body , Map<String , String> headerParams , Callback callback)
    {
        ...
        Request request = this.buildHttpRequest(httpSchema , Constants.CLOUDAPI_POST , Constants.APP_HOST , path , pathParams , queryParams , null  , body , Constants.CLOUDAPI_CONTENT_TYPE_STREAM , Constants.CLOUDAPI_CONTENT_TYPE_JSON , headerParams);
        Call call = client.newCall(request);
        try {
            Response respnose = call.execute();
            callback.onResponse(call , respnose);
    ...
    public void httpPutBytes(String path , Map<String , String> pathParams , Map<String , String> queryParams , byte[] body , Map<String , String> headerParams , Callback callback)
    {
        ...
        Request request = this.buildHttpRequest(httpSchema , Constants.CLOUDAPI_PUT , Constants.APP_HOST , path , pathParams , queryParams , null  , body , Constants.CLOUDAPI_CONTENT_TYPE_STREAM , Constants.CLOUDAPI_CONTENT_TYPE_JSON , headerParams);
        Call call = client.newCall(request);
        try {
            Response respnose = call.execute();
            callback.onResponse(call , respnose);
    ...
    public void httpDelete(String path , Map<String , String> pathParams , Map<String , String> queryParams , Map<String , String> headerParams , Callback callback)
    {
        ...
        Request request = this.buildHttpRequest(httpSchema , Constants.CLOUDAPI_DELETE , Constants.APP_HOST , path , pathParams , queryParams , null  , null , Constants.CLOUDAPI_CONTENT_TYPE_FORM , Constants.CLOUDAPI_CONTENT_TYPE_JSON , headerParams);
        Call call = client.newCall(request);
        try {
            Response respnose = call.execute();
            callback.onResponse(call , respnose);
    ...
    private Request buildHttpRequest(String protocol , String method , String host , String path , Map<String , String> pathParams , Map<String , String> queryParams , Map<String , String> formParams , byte[] body , String requestContentType , String acceptContentType , Map<String , String> headerParams){
        ...
        //设置请求头中的时间戳
        headerParams.put(Constants.CLOUDAPI_HTTP_HEADER_DATE , getHttpDateHeaderValue(current));

        //设置请求头中的时间戳，以timeIntervalSince1970的形式
        headerParams.put(Constants.CLOUDAPI_X_CA_TIMESTAMP, String.valueOf(current.getTime()));

        //请求放重放Nonce,15分钟内保持唯一,建议使用UUID
        headerParams.put(Constants.CLOUDAPI_X_CA_NONCE, UUID.randomUUID().toString());

        //设置请求头中的UserAgent
        headerParams.put(Constants.CLOUDAPI_HTTP_HEADER_USER_AGENT, Constants.CLOUDAPI_USER_AGENT);

        //设置请求头中的主机地址
        headerParams.put(Constants.CLOUDAPI_HTTP_HEADER_HOST , host);

        //设置请求头中的Api绑定的的AppKey
        headerParams.put(Constants.CLOUDAPI_X_CA_KEY, Constants.APP_KEY);

        //设置签名版本号
        headerParams.put(Constants.CLOUDAPI_X_CA_VERSION , Constants.CLOUDAPI_CA_VERSION_VALUE);

        //设置请求数据类型
        headerParams.put(Constants.CLOUDAPI_HTTP_HEADER_CONTENT_TYPE , requestContentType);

        //设置应答数据类型
        headerParams.put(Constants.CLOUDAPI_HTTP_HEADER_ACCEPT , acceptContentType);
         ...
         */
            ...
            headerParams.put(Constants.CLOUDAPI_HTTP_HEADER_CONTENT_MD5 , this.base64AndMD5(body));
        }
         ...
         */
        headerParams.put(Constants.CLOUDAPI_X_CA_SIGNATURE , SignUtil.sign(method , headerParams , pathWithPathParameter , queryParams , formParams));
