 ...
 * 转出奖券状态
 */
public class TurnOutIntegralStateActivity extends BaseActivity implements View.OnClickListener {
    //              转出时间  转出奖券   手续费
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turn_out_integral_state);
        initToolbar();
